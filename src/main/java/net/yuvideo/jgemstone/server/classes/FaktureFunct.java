...
public class FaktureFunct {
  ...
  /**
   * / * <p> 1. Proveriti da li je korisnik userID firma <br> 1.1 Ako ne, return; <br> 1.2 Ako da..
   * <br> 1.2.1 Pogledati dali ima fakture za ovu godinu, ako nema napraviti novu fakturu za ovu
   * godinu sa brojem 1 importovati data ako ima uzeti id fakture i importovati data </p>
   *
  ...
  /**
   * provera da li korisnik ima firmu ako nema hasFirma = false i zavrsavamo ako ima firmu pravimo
   * fakturu
   */
