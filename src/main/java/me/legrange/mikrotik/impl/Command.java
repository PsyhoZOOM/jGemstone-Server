...
/**
 * A command sent to a Mikrotik. This internal class is used to build complex commands with
 * parameters, queries and property lists.
 *
...
class Command {
  ...
  public String toString() {
    return String
        .format("cmd[%s] = %s, params = %s, queries = %s, props=%s ", tag, cmd, params, queries,
            properties);
  }
